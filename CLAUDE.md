...
- **La app es de análisis deportivo, no para apostar.** No acepta apuestas ni gestiona dinero
  (nada de banca, stakes ni registro de apuestas). Las cuotas se muestran solo como información
  en el Buscador de cuotas. Si algo empuja hacia apostar o mover dinero, pregunta antes.
